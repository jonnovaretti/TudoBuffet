...
namespace TudoBuffet.Website.Repositories.Contracts
{
    public interface IBuffets
    {
        ...
        Task<IEnumerable<Buffet>> GetBuffets(string uf, string cidade, BuffetCategory? buffetCategory, BuffetEnvironment? buffetEnvironment, RangePrice? rangePrice, string name = null);
